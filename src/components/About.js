        ...
        <div className="sectional-content" >
          ...
          <div className="types-photos" >
            ...
            <div className="pregnant" >
              <img key="logo-frid" src={process.env.PUBLIC_URL + "/assets/amarillas4.jpg"} alt="logo-fridarte"/>
              <div className="text">
                <h6>Embarazadas</h6>
            ...
            <div className="pregnant" >
            <img key="logo-frid" src={process.env.PUBLIC_URL + "/assets/amarillas5.jpg"} alt="logo-fridarte"/>
              <div className="text">
                <h6>Niños</h6>
            ...
            <div className="pregnant" >
            <img key="logo-frid" src={process.env.PUBLIC_URL + "/assets/amarillas6.jpg"} alt="logo-fridarte"/>
              <div className="text">
                <h6>Quinces</h6>
            ...
            <div className="pregnant" >
            <img key="logo-frid" src={process.env.PUBLIC_URL + "/assets/amarillas7.jpg"} alt="logo-fridarte"/>
              <div className="text">
                <h6>Modelos</h6>
            ...
            <div className="pregnant" >
            <img key="logo-frid" src={process.env.PUBLIC_URL + "/assets/amarillas8.jpg"} alt="logo-fridarte"/>
              <div className="text">
                <h6>Bodas</h6>
